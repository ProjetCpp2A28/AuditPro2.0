...
#include "ui_interface_rapport.h"
...
Interface_rapport::Interface_rapport(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Interface_rapport)
{
    ui->setupUi(this);
    chartView=nullptr;
    chart=nullptr;
...
Interface_rapport::~Interface_rapport()
{
    delete ui;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////arduino
void Interface_rapport::on_pushButton_changer_clicked()
{
...
void Interface_rapport::on_pushButton_valide_clicked()
{
    QString ID_RAPPORT=ui->lineEdit_id->text();
    QString RESULTAT;
    QSqlQuery query;
...
void Interface_rapport::on_arduino_clicked()
{
...
/*void Interface_rapport::id_existe()
{
    enteredID =A.read_from_arduino() ;
    QString ID_RAPPORT=QString::fromUtf8(enteredID);
    QString RESULTAT;
...
////---------------------------TableView-------------------------------////
/*void Interface_rapport::show_table()
{
...
void Interface_rapport::clear_form( )
{
...
/////////////////////////////////////*********************CRUD***********************//////////////////////////////////////////
////////////////Create
/*void Interface_rapport::on_pushButton_ajouter_clicked()
{
...
////////////////Read
void Interface_rapport::on_pushButton_afficher_clicked()
{
    show_table();
}

////////////////Update
void Interface_rapport::on_pushButton_check_clicked()
{
...
void Interface_rapport::on_pushButton_modifier_clicked()
{
    QRegularExpression numericRegex("^[0-9]+$");
...
////////////////Delete
void Interface_rapport::on_pushButton_supprimer_clicked()
{
...
/////////////////////////////////////*********************Metiers***********************//////////////////////////////////////////
///////////Recherche
/*void Interface_rapport::on_rech_textChanged(const QString &text)
{
    proxy->setFilterRegularExpression(QRegularExpression(text, QRegularExpression::CaseInsensitiveOption));
}
void Interface_rapport::on_comboBox_rech_currentIndexChanged(int index)
{
    proxy->setFilterKeyColumn(index);
}

///////////Trier
void Interface_rapport::on_comboBox_trie_currentIndexChanged(int index)
{
...
///////////Statistique
/// Bar chart
/*void Interface_rapport::on_pushButton_stat_resultat_clicked()
{

    QSqlQuery q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12;
    qreal c1=0,c2=0,c3=0;
    qreal c4=0,c5=0,c6=0;
    qreal c7=0,c8=0,c9=0;
    qreal totmax;
        ///// Janvier
...
void Interface_rapport::on_pushButton_stat_entreprise_clicked()
{
...
/////////////export pdf
void Interface_rapport::on_pushButton_pdf_clicked()
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////Cryptage
void Interface_rapport::showPasswordDialog()
{
...
bool Interface_rapport::checkPassword(const QString &password)
{
    QString storedPassword = "123456";
    return (password == storedPassword);
}
QString Interface_rapport::getPasswordFromUser()
{
    return QInputDialog::getText(this, "Mot de passe", "Entrez votre mot de passe :", QLineEdit::Password);
}
QByteArray Interface_rapport::encrypt(const QByteArray &data,QByteArray key)
{
...
QByteArray Interface_rapport::decrypt(const QByteArray &data, const QByteArray &key)
{
...
void Interface_rapport::on_pushButton_cryptage_clicked()
{
    QString password = getPasswordFromUser();
    if (!password.isEmpty())
    {
...
void Interface_rapport::on_pushButton_decryptage_clicked()
{
    QString password = getPasswordFromUser();
    if (!password.isEmpty())
    {
...
/*void Interface_rapport::on_pushButton_Employee_clicked()
{
    //bool isemployeevisible = ui->widget_emp_2->isVisible();
    ui->widget_emp_2->setVisible(true);
    ui->widget_rapport->setVisible(false);

    //ui->Mainobdy->setVisible(false);
}


void Interface_rapport::on_pushButton_rapport_clicked()
{
    //bool israpportvisible = ui->widget_rapport->isVisible();
    ui->widget_rapport->setVisible(true);
    ui->widget_emp_2->setVisible(false);
